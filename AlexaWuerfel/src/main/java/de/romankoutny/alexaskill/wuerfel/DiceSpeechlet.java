package de.romankoutny.alexaskill.wuerfel;
...
public class DiceSpeechlet implements Speechlet 
{
	...
	public SpeechletResponse onLaunch(final LaunchRequest request, final Session session) throws SpeechletException 
	{
		...
		speech.setText("Willkommen beim Würfeln.");
	...
	{
		PlainTextOutputSpeech speech = new PlainTextOutputSpeech();
		String numSlot = intent.getSlot(SLOT_NUMBEROFSIDES).getValue(); 
		log.info("Sides: " + numSlot);
		...
		{
			Integer numberOfSides = Integer.valueOf(numSlot);
